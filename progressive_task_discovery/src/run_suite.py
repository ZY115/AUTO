...
def main():
    ...
    shutil.copy(ROOT / 'src/pilot.cpp', out / 'pilot_snapshot.cpp')
    manifest = {'source_sha256': hashlib.sha256((ROOT / 'src/pilot.cpp').read_bytes()).hexdigest(),
                'binary_sha256': hashlib.sha256((ROOT / 'pilot').read_bytes()).hexdigest(),

...
def main():
    ...
    shutil.copy(ROOT / 'src/unordered.cpp', out / 'unordered_snapshot.cpp')
    manifest = {'source_sha256': hashlib.sha256((ROOT / 'src/unordered.cpp').read_bytes()).hexdigest(),
                'binary_sha256': hashlib.sha256((ROOT / 'unordered').read_bytes()).hexdigest(),

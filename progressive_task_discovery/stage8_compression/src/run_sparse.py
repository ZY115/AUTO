...
def main():
    ...
    shutil.copy(ROOT / 'src/sparse.cpp', out / 'sparse_snapshot.cpp')
    manifest = {'source_sha256': hashlib.sha256((ROOT / 'src/sparse.cpp').read_bytes()).hexdigest(),
                'binary_sha256': hashlib.sha256((ROOT / 'sparse').read_bytes()).hexdigest(),

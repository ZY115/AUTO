...
struct Agent {
    ...
    double policy_value(int q,int s,int a)const {return goal&&edge[q]>=0?G[(edge[q]*N+s)*4+a]:Q[ix(q,s,a)];}
...
int main(int argc,char**argv) {
    ...
    const std::vector<std::string> methods={"flat","count","discovered","oracle_state","progressive","count_frontier","learned_qrm","progressive_qrm","oracle_qrm","goal_reuse","progressive_goal","oracle_goal","option_count","option_progressive","option_qrm","option_progressive_qrm","count_replay","option_replay"};
